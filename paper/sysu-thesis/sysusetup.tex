...
\sysusetup{
  title                = {面向自动驾驶长尾场景的免训练分层边缘云协同感知方法},
  title*               = {A Training-Free Hierarchical Edge-Cloud Perception Method for Long-Tail Autonomous Driving Scenarios},
  author               = {作者待补充},
  ...
  % professional-type*   = {Professional degree type},
   ...
   student-id           = {00000000},  % 学号，本科生需要填写
...
% 配置图片的默认目录
\graphicspath{{image/}{image/thesis/}}
